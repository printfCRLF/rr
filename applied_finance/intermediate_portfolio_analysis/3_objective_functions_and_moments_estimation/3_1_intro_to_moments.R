sample_moments_estimates <- function() {
...
advanced_moments_estimates <- function() {
...
define_a_custom_moments_function <- function() {
...
optimization_with_custom_moment_function <- function() {
...
optimization_with_custom_object_function <- function() {
